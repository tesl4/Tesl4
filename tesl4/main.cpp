...
HRESULT InitDevice()
{
	...
	bd.ByteWidth = sizeof(TVertex) * 24;
	...
	sampleDsc.AddressU = D3D11_TEXTURE_ADDRESS_WRAP;
	sampleDsc.AddressV = D3D11_TEXTURE_ADDRESS_WRAP;
	sampleDsc.AddressW = D3D11_TEXTURE_ADDRESS_WRAP;
	sampleDsc.ComparisonFunc = D3D11_COMPARISON_NEVER;
	sampleDsc.MinLOD = 0;
	sampleDsc.MaxLOD = D3D11_FLOAT32_MAX;
	...
	cbChangeonresize.mProjection = XMMatrixTranspose(g_Projection);
